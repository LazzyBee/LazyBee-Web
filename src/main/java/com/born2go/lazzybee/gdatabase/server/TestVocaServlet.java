...
public class TestVocaServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		// LinkedHashMap<String, String> hmap = new LinkedHashMap<String,
		// String>();
		...
		resp.getWriter().print(cl);
		resp.getWriter().print(map.get("1"));
		
		resp.getWriter().print(map.get("2"));
		
		resp.getWriter().print(map.get("3"));
